...
This document is the single source of truth for **how AquaSwap integrates a Stellar
wallet**. It maps each rubric requirement to the exact files and code that implement it.

> **TL;DR** — AquaSwap uses [`@stellar/freighter-api`](https://www.npmjs.com/package/@stellar/freighter-api)
...
AquaSwap depends on the official Freighter API (`frontend/package.json`):
