...
export async function insertPairSnapshot(
  pairId: string,
  reserveX: bigint,
  reserveY: bigint,
  ledger: number,
  ...
  await query(
    `INSERT INTO pair_snapshots (pair_id, reserve_x, reserve_y, ledger, ts)
     VALUES ($1, $2, $3, $4, $5)`,
    [pairId, reserveX.toString(), reserveY.toString(), ledger, ts],
  );
}
